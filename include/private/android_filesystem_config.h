...
static const struct fs_path_config android_files[] = {
    ...
    { 00440, AID_BLUETOOTH, AID_BLUETOOTH, 0, "system/etc/bluetooth/main.conf" },
    { 00440, AID_BLUETOOTH, AID_BLUETOOTH, 0, "system/etc/bluetooth/input.conf" },
    { 00440, AID_BLUETOOTH, AID_BLUETOOTH, 0, "system/etc/bluetooth/audio.conf" },
    { 00440, AID_BLUETOOTH, AID_BLUETOOTH, 0, "system/etc/bluetooth/network.conf" },
    { 00444, AID_NET_BT,    AID_NET_BT,    0, "system/etc/bluetooth/blacklist.conf" },
    { 00640, AID_SYSTEM,    AID_SYSTEM,    0, "system/etc/bluetooth/auto_pairing.conf" },
    { 00755, AID_ROOT,      AID_ROOT,      0, "system/addon.d/*" },
